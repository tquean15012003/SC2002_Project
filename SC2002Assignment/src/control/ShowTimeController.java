...
/**
 * This class controls all show-time-related services
 */
public class ShowTimeController {

    /**
     * This method controls viewing show times for an admin
     */
    ...
    /**
     * This method controls viewing show times for a movie goer
     */
    ...
    /**
     * This method controls adding a new show time
     */
    ...
    /**
     * This method controls updating details of show time
     */
    public static void updateShowTime() {
        ...
        switch (choice) {
            case 1:
                ...
                if (checkClash(showTime.getStartDateTime(), showTime.getMovie().getDuration(), showTimeList,
                        showTime)) {
                    isValid = false;
                }
                break;
    ...
    /**
     * This method controls removing a show time
     */
    ...
    /**
     * This method returns date & time from the console
     * 
     * @return the date & time from console
     */
    ...
    /**
     * This method returns true if the show time clash with others
     * 
     * @param startDateTime   the start date time of the show time
     * @param duration        the duration of the movie
     * @param showTimeList    the show time list
     * @param currentShowTime the show time that wants to check if clash
     * @return true if the show time clash with others
     */
    public static boolean checkClash(LocalDateTime startDateTime, String duration, ArrayList<ShowTime> showTimeList,
        ...
        for (ShowTime showTime : showTimeList) {
            ...
            LocalDateTime oldShowTimeEnd = oldShowTimeStart
                    .plus(Duration.ofMinutes(Integer.parseInt(showTime.getMovie().getDuration())));
            boolean isClash = ((oldShowTimeStart.isBefore(endDateTime) && !oldShowTimeStart.isEqual(endDateTime)) &&
    ...
    /**
     * This method returns show time list that is sorted by the date andtime start
     * 
     * @param showTimeList the show time list
     * @return returns show time list that is sorted by the date and time start
     */
